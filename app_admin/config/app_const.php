<?php
	...
	define('CONTENT_BLOCK_ABSOLUTE_ROOT_PATH', '/hotel/app_user/views/pages/content_block/');	// CONTENT_BLOCK_ABSOLUTE_ROOT_PATH
	define('CONTENT_LAYOUT_ROOT_PATH', '../../app_user/views/layouts/content_layout/');	// CONTENT_LAYOUT_ROOT_PATH
	define('CONTENT_LAYOUT_ABSOLUTE_ROOT_PATH', '/hotel/app_user/views/pages/content_layout/');	// CONTENT_LAYOUT_ABSOLUTE_ROOT_PATH
	define('CONTENT_PAGE_ROOT_PATH', '../../app_user/views/pages/content_page/');	// CONTENT_PAGE_ROOT_PATH
	define('CONTENT_PAGE_ABSOLUTE_ROOT_PATH', '/hotel/app_user/views/pages/content_page/');	// CONTENT_PAGE_ABSOLUTE_ROOT_PATH
	define('CONTENT_IMAGE_ROOT_PATH', '../../app_user/webroot/image/');	// CONTENT_IMAGE_ROOT_PATH
	define('CONTENT_IMAGE_ABSOLUTE_ROOT_PATH', '/hotel/app_user/webroot/image/');	// CONTENT_IMAGE_ABSOLUTE_ROOT_PATH
