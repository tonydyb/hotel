	...
	<tbody>
		...
		<tr>
			...
			<td>
				...
				<?php
					$street ='';
					$street .= empty($street) ? ', '.$request_hotel['hotel_addr_3'] : $request_hotel['hotel_addr_3'];
					$street .= empty($street) ? ', '.$request_hotel['hotel_addr_2'] : $request_hotel['hotel_addr_2'];
					$street .= empty($street) ? ', '.$request_hotel['hotel_addr_1'] : $request_hotel['hotel_addr_1'];
...
<div class=reservationinfoaddress>
	<?php
		...
		$present .= !empty($present) ? ', '.$request_hotel['hotel_agent']['addr_3'] : $request_hotel['hotel_agent']['addr_3'];
		$present .= !empty($present) ? ', '.$request_hotel['hotel_agent']['addr_2'] : $request_hotel['hotel_agent']['addr_2'];
		$present .= !empty($present) ? ', '.$request_hotel['hotel_agent']['addr_1'] : $request_hotel['hotel_agent']['addr_1'];
		$present .= !empty($present) ? ', '.$request_hotel['hotel_agent']['postcode'] : $request_hotel['hotel_agent']['postcode'];
		$present .= !empty($present) ? ', '.$request_hotel['hotel_agent']['country'] : $request_hotel['hotel_agent']['country'];
	...
	<table class=emergencytable>
		<tbody>
			<tr>
				<td class=firstrow>
					<?php
						echo $request_hotel['hotel_agent']['name'].'<br />';
						$present = '';
						$present .= !empty($present) ? ', '.$request_hotel['hotel_agent']['addr_3'].'<br />' : $request_hotel['hotel_agent']['addr_3'].'<br />';
						$present .= !empty($present) ? ', '.$request_hotel['hotel_agent']['addr_2'].'<br />' : $request_hotel['hotel_agent']['addr_2'].'<br />';
						$present .= !empty($present) ? ', '.$request_hotel['hotel_agent']['addr_1'].'<br />' : $request_hotel['hotel_agent']['addr_1'].'<br />';
						$present .= !empty($present) ? ', '.$request_hotel['hotel_agent']['postcode'] : $request_hotel['hotel_agent']['postcode'];
						$present .= !empty($present) ? ', '.$request_hotel['hotel_agent']['country'].'<br />' : $request_hotel['hotel_agent']['country'].'<br />';
					?>
				</td>
				<td class=secondrow>t +<?php echo $request_hotel['hotel_agent']['tel'] ?>(24 hours/7 days)</td>
