 ...
 */
	function testFormInput() {
		...
		$result = $this->Form->input('Model.field', array('error' => array('minLength' => __('Le login doit contenir au moins 2 caract竪res', true))));
		$expected = array(
			'div' => array('class' => 'input text error'),
			'label' => array('for' => 'ModelField'),
			'Field',
			...
			'input' => array('type' => 'text', 'name' => 'data[Model][field]', 'value' => '', 'id' => 'ModelField', 'class' => 'form-error'),
			array('div' => array('class' => 'error-message')),
			'Le login doit contenir au moins 2 caract竪res',
			'/div',
			'/div'
		);
		$this->assertTags($result, $expected);
 ...
 **/
	function testInputSelectType() {
		$result = $this->Form->input('email', array(
			'options' => array('竪' => 'Fir辿st', '辿' => 'Seco竪nd'), 'empty' => true)
		);
		$expected = array(
			...
			'/option',
			array('option' => array('value' => '竪')),
			'Fir辿st',
			'/option',
			array('option' => array('value' => '辿')),
			'Seco竪nd',
			'/option',
			'/select',
			'/div'
 ...
 */
	function testTextAreaWithStupidCharacters() {
		$result = $this->Form->input('Post.content', array(
			'label' => 'Current Text', 'value' => "GREAT速", 'rows' => '15', 'cols' => '75'
		));
		$expected = array(
			'div' => array('class' => 'input text'),
